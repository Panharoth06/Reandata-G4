...
const DataSet = () => {
  ...
  return (
    <main className="font-roboto flex flex-col min-h-screen">
      ...
      {/* Subtitle Section */}
      <section className="w-full py-6 md:py-10 bg-gray-100 px-2 sm:px-36 md:px-6 text-white">
        <div className="container mx-auto sm:px-[7.5rem] text-center md:text-left"
          data-aos="fade-up" data-aos-duration="1000" data-aos-delay="200">
          <p className="text-[#22B04B] text-xl md:text-2xl lg:text-[32px] font-bold" style={{ lineHeight: "1.5" }}>
            Get to know about
          </p>
          <h2 className="text-[#3C55A5] font-bold text-3xl md:text-5xl lg:text-[38px] leading-tight">
      ...
      {/* Steps Section */}
      <section className="w-full py-8 sm:px-[4.5rem] bg-gray-100">
        <div className="container mx-auto px-4">
          <div className="px-4 md:px-8 lg:px-12">
            <h2 className="text-center text-[#3C55A5] text-2xl md:text-3xl lg:text-[38px] font-bold mb-6 leading-loose">
              Processing of Data
            </h2>
          </div>
        </div>
